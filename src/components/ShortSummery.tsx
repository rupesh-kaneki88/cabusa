    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Text content */}
                <div 
                    className="summary-text font-montserrat font-bold text-lg md:text-2xl lg:text-3xl w-[300px] md:w-[490px] text-right leading-relaxed relative z-10 uppercase italic"
